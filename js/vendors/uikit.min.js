...
! function(t, e) {
    ...
    function Tt(t, s, e) {
      ...
      Ct(t = t.replace(_t, "$1 *")) && (a = [], t = t.match(At).map(function(t) {
        ...
        var i, n, r, o = s;
        return "!" === t[0] && (i = t.substr(1).trim().split(" "), o = Bt(Pt(s), i[0]), t = i.slice(1).join(" ").trim()), "-" === t[0] && (n = t.substr(1).trim().split(" "), r = (o || s).previousElementSibling, o = zt(r, t.substr(1)) ? r : null, t = n.slice(1).join(" ")), o ? (o.id || (o.id = "uk-" + Date.now() + e, a.push(function() {
          return at(o, "id")
        })), "#" + Ht(o.id) + " " + t) : null
    ...
    function Bt(t, e) {
      return w(e, ">") && (e = e.slice(1)), M(t) ? Dt.call(t, e) : V(t).map(function(t) {
        return Bt(t, e)
      }).filter(Boolean)
    }
    ...
    function Xt() {
      ...
      var i, n, r = Qt(t),
        ...
        u = r[4],
        o = ne(o);
      return 1 < h.length && (i = h, h = function(t) {
    ...
    function Gt(t, e, i, n) {
      void 0 === n && (n = !1), n = te(n), t = ne(t), e.split(" ").forEach(function(e) {
        return t.forEach(function(t) {
    ...
    function Zt(t, e, i, n) {
      var r;
      return void 0 === e && (e = !0), void 0 === i && (i = !1), D(t) && ((r = document.createEvent("CustomEvent")).initCustomEvent(t, e, i, n), t = r), t
    }
    ...
    function ge(t, e, i, n) {
      ...
      var r = (e = V(e)).length;
      return t = P(t) ? F(t) : "next" === t ? i + 1 : "previous" === t ? i - 1 : me(e, t), n ? tt(t, 0, r - 1) : (t %= r) < 0 ? t + r : t
    }
    ...
    function we(t, e) {
      return t = Me(t), H(e) ? t.innerHTML : be(t.hasChildNodes() ? ve(t) : t, e)
    }
    ...
    function Ce(t) {
      ...
      return Ee.test(t) ? i.insertAdjacentHTML("beforeend", t.trim()) : i.textContent = t, 1 < i.childNodes.length ? V(i.childNodes) : i.firstChild
    }
    ...
    function Le(t) {
      ...
      r.length && (n = D(K(r = je(r))) ? [] : r.pop(), r = r.filter(Boolean), V(t).forEach(function(t) {
        for (var e = t.classList, i = 0; i < r.length; i++) We.Force ? e.toggle.apply(e, [r[i]].concat(n)) : e[(H(n) ? !e.contains(r[i]) : n) ? "add" : "remove"](r[i])
      }))
    }
    ...
    function Xe(t) {
      ...
      return ct ? (t in Ye || (De(e = be(i, document.createElement("div")), "uk-" + t), Ye[t] = Ue(e, "content", ":before").replace(/^["'](.*)["']$/, "$1"), $e(e)), Ye[t]) : qe(i).getPropertyValue("--uk-" + t)
    }
    var Ge = {};
      ...
      return void 0 === s && (s = 200), ae.all(V(t).map(function(o) {
        return new ae(function(i, n) {
          ...
          Kt(o, "animationend animationcancel", function(t) {
            ...
            self: !0
          }), Re(o, "animationDuration", s + "ms"), De(o, e, ti + (h ? "leave" : "enter")), w(e, ti) && De(o, a && "uk-transform-origin-" + a, h && ti + "reverse")
        })
      }))
    }
    ...
    function ai(t) {
      ...
      jt(t) || "none" !== Re(t, "display") || (e = ot(t, "style"), i = ot(t, "hidden"), ot(t, {
    ...
    function fi(i, t, e) {
      return void 0 === e && (e = "border-box"), Re(i, "boxSizing") === e ? ri[t].slice(1).map(p).reduce(function(t, e) {
    ...
    qi.util = Object.freeze({
        ...
        scrollParents: Li,
        getViewport: Fi
      }), qi.data = "__uikit__", qi.prefix = "uk-", qi.options = {}, qi.version = "3.5.3", Xi = (Ui = qi).data, Ui.use = function(t) {
        ...
        }), t = r.map(d).concat(this.$name), this._observer.observe(o, {
          attributes: !0,
      ...
      an = {
        ...
        methods: {
          ...
          _toggle: function(t, e) {
            var i;
            t && (e = Boolean(e), this.cls ? (i = b(this.cls, " ") || e !== He(t, this.cls)) && Le(t, this.cls, b(this.cls, " ") ? void 0 : e) : (i = e === st(t, "hidden")) && ot(t, "hidden", e ? null : ""), Ne("[autofocus]", t).some(function(t) {
              return jt(t) ? t.focus() || !0 : t.blur()
            }), this.updateAria(t), i && (Jt(t, "toggled", [this]), this.$update(t)))
          }
        }
      };
    ...
    function hn(t) {
      ...
      return function(t, e) {
        ...
        var o = ci(t) + (i ? 0 : n);
        return ci(t, r), (e ? Qe.start(t, G({}, h, {
          overflow: "hidden",
          height: o
    ...
    var un = {
      ...
      events: [{
        ...
        handler: function(t) {
          t.preventDefault(), this.toggle(me(Ne(this.targets + " " + this.$props.toggle, this.$el), t.current))
        }
      }],
      methods: {
        toggle: function(t, r) {
          ...
          this.multiple || b(i, e[0]) || (e = e.concat(i)), (this.collapsible || Rt(e, ":not(." + this.clsOpen + ")").length) && e.forEach(function(t) {
            return o.toggleElement(t, !He(t, o.clsOpen), function(e, i) {
              ...
              if (!1 !== r && o.hasTransition) return e._wrapper || (e._wrapper = Ie(n, "<div" + (i ? " hidden" : "") + ">")), cn(n, !1), hn(o)(e._wrapper, i).then(function() {
                var t;
                cn(n, !i), delete e._wrapper, Te(n), i && (Bi(t = Me(o.$props.toggle, e)) || Oi(t, {
                  offset: o.offset
                }))
              });
              cn(n, !i)
        ...
        methods: {
          show: function(t, e) {
            ...
            if (void 0 === t && (t = this.toggle), void 0 === e && (e = !0), this.isToggled() && t && this.toggle && t.$el !== this.toggle.$el && this.hide(!1), this.toggle = t, this.clearTimers(), !this.isActive()) {
              if (pn) {
                if (e && pn.isDelaying) return void(this.showTimer = setTimeout(this.show, 10));
                for (; pn && i !== pn && !qt(this.$el, pn.$el);)(i = pn).hide(!1)
              }
          ...
          hide: function(t) {
            ...
            var n, r;
            this.clearTimers(), this.isDelaying = (n = this.$el, r = [], Ae(n, function(t) {
    ...
    var vn = {
      ...
      bn = {
        ...
        update: {
          read: function() {
            return {
              columns: (t = this.$el.children, e = yn(t, "left", "right"), lt ? e.reverse() : e),
      ...
      update: [{
        ...
        read: function(t) {
          ...
          var r, o, s, a, h, u = n.some(Qe.inProgress),
            ...
            d = (r = n, o = this.margin, j((s = r.filter(function(t) {
              return He(t, o)
            })[0]) ? Re(s, "marginTop") : Re(r[0], "paddingLeft")) * (i.length - 1)),
            f = Math.max.apply(Math, l) + d;
          this.masonry && (e = e.map(function(t) {
            return Z(t, "offsetTop")
          }), a = e, h = i.map(function(t) {
    ...
    function Tn(t) {
      ...
      return o && s && (Re(t, "minHeight", ""), e = En(t), n = e.heights, r = e.max), {
    ...
    var _n = {
      ...
      update: {
        ...
        write: function(t) {
          ...
          Re(this.$el, {
            minHeight: e
          }), e !== i && this.$update(this.$el, "resize"), this.minHeight && j(Re(this.$el, "minHeight")) < this.minHeight && Re(this.$el, "minHeight", this.minHeight)
        },
        events: ["resize"]
      }
    };
            ...
            return function(i) {
              ...
              return function(t, e) {
                e && b(t, "<symbol") && (t = function(t, e) {
                  if (!zn[t]) {
                    var i;
                    for (zn[t] = {}, Nn.lastIndex = 0; i = Nn.exec(t);) zn[t][i[3]] = '<svg xmlns="http://www.w3.org/2000/svg"' + i[1] + "svg>"
                  }
                  return zn[t][e]
                }(t, e) || t);
    ...
    var Rn = {
      ...
      connected: function() {
        Qn[this.cacheKey] ? qn(this.$el, Qn[this.cacheKey] || this.dataSrc, this.dataSrcset, this.sizes) : this.isImg && this.width && this.height && qn(this.$el, function(t, e, i) {
          ...
          i && (n = rt.ratio({
            width: t,
            height: e
          }, "width", wi(Yn(i))), t = n.width, e = n.height);
      ...
      update: {
        ...
        write: function(t) {
          var e, i, n, r, o;
          this.dataSrcset && 1 !== window.devicePixelRatio && (!(e = Re(this.$el, "backgroundSize")).match(/^(auto\s?)+$/) && j(e) !== t.bgSize || (t.bgSize = (i = this.dataSrcset, n = this.sizes, r = wi(Yn(n)), (o = (i.match(Kn) || []).map(j).sort(function(t, e) {
            return t - e
          })).filter(function(t) {
            return r <= t
      ...
      methods: {
        load: function(t) {
          ...
          t.some(function(t) {
            ...
            return qn(e.$el, Zn(t), t.srcset, t.sizes), Qn[e.cacheKey] = Zn(t), t
    ...
    function qn(t, e, i, n) {
      Jn(t) ? (n && (t.sizes = n), i && (t.srcset = i), e && (t.src = e)) : e && !b(t.style.backgroundImage, e) && (Re(t, "backgroundImage", "url(" + Ht(e) + ")"), Jt(t, Zt("load", !1)))
    }
        ...
        events: [{
          ...
          handler: function() {
            ...
            li(window) - li(document) && this.overlay && Re(document.body, "overflowY", "scroll"), this.stack && Re(this.$el, "zIndex", Re(this.$el, "zIndex") + rr.length), De(document.documentElement, this.clsPage), this.bgClose && Kt(this.$el, "hide", Xt(document, mt, function(t) {
              ...
              27 === t.keyCode && K(rr) === o && (t.preventDefault(), o.hide())
            }), {
              self: !0
            })
          }
    ...
    var ar = {
      install: function(t) {
        ...
        a.dialog = function(t, e) {
          ...
          return i.show(), Xt(i.$el, "hidden", function() {
      ...
      events: [{
        ...
        self: !0,
        handler: function() {
          He(this.panel, "uk-margin-auto-vertical") ? De(this.$el, "uk-flex") : Re(this.$el, "display", "block"), ci(this.$el)
        }
      }, {
        name: "hidden",
        self: !0,
      ...
      ur = {
        ...
        events: [{
          ...
          handler: function(t, e) {
            ...
            })), this.clsDrop && De(i, this.clsDrop + "-dropbar"), "bottom" === n && this.transitionTo(i.offsetHeight + j(Re(i, "marginTop")) + j(Re(i, "marginBottom")), i)
          }
        }, {
          name: "beforehide",
          filter: function() {
        ...
        methods: {
          ...
          transitionTo: function(t, e) {
            var i = this,
              n = this.dropbar,
              r = jt(n) ? ci(n) : 0;
            return Re(e = r < t && e, "clip", "rect(0," + e.offsetWidth + "px," + r + "px,0)"), ci(n, r), Qe.cancel([e, n]), ae.all([Qe.start(n, {
              height: t
    ...
    var dr = {
      ...
      pr = {
        ...
        methods: {
          scrollTo: function(t) {
            var e = this;
            t = t && Me(t) || document.body, Jt(this.$el, "beforescroll", [this, t]) && Oi(t, {
              offset: this.offset
            }).then(function() {
        ...
        update: [{
          ...
          write: function(n) {
            ...
            this.elements.forEach(function(e) {
              function t(t) {
                Re(e, "visibility", !t && r.hidden ? "hidden" : ""), Le(e, r.inViewClass, t), Le(e, i.cls), Jt(e, t ? "inview" : "outview"), i.inview = t, r.$update(e)
              }
              var i = e._ukScrollspyState;
              !i.show || i.inview || i.queued ? !i.show && i.inview && !i.queued && r.repeat && t(!1) : (i.queued = !0, n.promise = (n.promise || ae.resolve()).then(function() {
                return new ae(function(t) {
        ...
        update: [{
          ...
          write: function(t) {
            ...
            this.links.forEach(function(t) {
              return t.blur()
            }), Be(this.elements, this.cls), !1 !== e && Jt(this.$el, "active", [e, De(this.elements[e], this.cls)])
          },
          events: ["scroll", "resize"]
        }]
      },
      vr = {
        ...
        computed: {
          ...
          isActive: {
            ...
            set: function(t) {
              t && !this.isActive ? (Oe(this.selTarget, this.clsInactive, this.clsActive), Jt(this.$el, "active")) : t || He(this.selTarget, this.clsInactive) || (Oe(this.selTarget, this.clsActive, this.clsInactive), Jt(this.$el, "inactive"))
            }
          }
        },
        connected: function() {
        ...
        update: [{
          read: function(t, e) {
            ...
            return this.top = Math.max(j(wr("top", this)), this.topOffset) - this.offset, this.bottom = n && n - this.$el.offsetHeight, this.inactive = !this.matchMedia, {
              lastScroll: !1,
              height: i,
          ...
          write: function(t) {
            ...
            Re(n, G({
              height: e
            }, i)), qt(n, document) || (ye(this.$el, n), ot(n, "hidden", "")), this.isActive = !!this.isActive
          },
          events: ["resize"]
        }, {
          read: function(t) {
            var e = t.scroll;
            return void 0 === e && (e = 0), this.width = si(jt(this.widthElement) ? this.widthElement : this.$el).width, this.scroll = window.pageYOffset, {
    ...
    var br, xr, yr, kr = {
      ...
      Ir = {
        ...
        methods: {
          toggle: function(t) {
            var e, i = this;
            Jt(this.target, t || "toggle", [this]) && (this.queued ? (e = this.target.filter(this.isToggled), this.toggleElement(e, !1).then(function() {
    ...
    J(Object.freeze({
      ...
      ut && pe(function() {
        ...
        Xt(document, "animationstart", function(t) {
          var e = t.target;
          (Re(e, "animationName") || "").match(/^uk-.*(left|right)/) && (n++, Re(document.body, "overflowX", "hidden"), setTimeout(function() {
      ...
      new MutationObserver(function(t) {
        ...
        t.forEach(function(t) {
          return i = r, n = (e = t).target, void(("attributes" !== e.type ? function(t) {
            for (var e = t.addedNodes, i = t.removedNodes, n = 0; n < e.length; n++) Ae(e[n], xr);
          ...
          animate: function(t) {
            ...
            var s = ci(this.target),
              ...
              o = a.map(function(t, e) {
                ...
                return i && (t ? "opacity" in t || (i.opacity % 1 ? t.opacity = 1 : delete i.opacity) : delete i.opacity), i
              });
            return De(this.target, Er), r.forEach(function(t, e) {
              return o[e] && Re(t, o[e])
            }), Re(this.target, {
              height: e,
              display: "block"
            }), Pi(window, i), ae.all(r.map(function(t, e) {
              ...
              }), Ar(n.target), n.$update(n.target, "resize"), xi.flush()
            }, et)
          }
        }
      };
    ...
    var Nr = {
      ...
      computed: {
        toggles: {
          ...
          watch: function() {
            var e, i = this;
            this.updateState(), !1 !== this.selActive && (e = Ne(this.selActive, this.$el), this.toggles.forEach(function(t) {
      ...
      methods: {
        ...
        setState: function(u, t) {
          ...
          void 0 === t && (t = !0), u = G({
            ...
            sort: []
          }, u), Jt(this.$el, "beforeFilter", [this, u]);
          var l = this.children;
          ...
          function e() {
            ...
            var n, r, o, s = u.sort,
              a = s[0],
              h = s[1];
            a && (r = a, o = h, Y(n = G([], l).sort(function(t, e) {
      ...
      mixins: [{
          ...
          move: function(t) {
            ...
            if (this.unbindMove) {
              ...
              if (!(0 == i || this.prevPos === this.pos || !this.dragging && Math.abs(i) < this.threshold)) {
                ...
                }), (this.index === r && this.prevIndex !== r || h) && Jt(n[this.index], "itemshown", [this]), l && (this.prevIndex = r, this.index = s, d || Jt(u, "beforeitemhide", [this]), Jt(c, "beforeitemshow", [this])), this._transitioner = this._translate(Math.abs(this.percent), u, !d && c), l && (d || Jt(u, "itemhide", [this]), Jt(c, "itemshow", [this]))
              }
            }
          },
          end: function() {
        ...
        update: {
          write: function() {
            ...
            }).join("")), Le(Ne(this.selNavItem, this.$el).concat(this.nav), "uk-hidden", !this.maxIndex), this.updateNav()
          },
          events: ["resize"]
        },
        events: [{
      ...
      methods: {
          ...
          if (void 0 === e && (e = !1), !this.dragging && this.length) {
            ...
            if (n[e ? "unshift" : "push"](t), !e && 1 < n.length) 2 === n.length && this._transitioner.forward(Math.min(this.duration, 200));
              ...
              var s, a, h = this.getIndex(this.index),
                ...
                l = this.slides[c];
              if (u !== l) {
                if (this.dir = (a = h, "next" !== (s = t) && ("previous" === s || s < a) ? -1 : 1), this.prevIndex = h, this.index = c, u && !Jt(u, "beforeitemhide", [this]) || !Jt(l, "beforeitemshow", [this, u])) return this.index = this.prevIndex, void o();
                var d = this._show(u, l, e).then(function() {
                  return u && Jt(u, "itemhidden", [i]), Jt(l, "itemshown", [i]), new ae(function(t) {
                    xi.write(function() {
                      n.shift(), n.length ? i.show(n.shift(), !0) : i._transitioner = null, t()
                    })
                  })
                });
                return u && Jt(u, "itemhide", [this]), Jt(l, "itemshow", [this]), d
              }
              o()
            }
          }
        ...
        _show: function(t, e, i) {
          if (this._transitioner = this._getTransitioner(t, e, this.dir, G({
            ...
            }, this.transitionOptions)), !i && !t) return this._translate(1), ae.resolve();
        ...
        _getTransitioner: function(t, e, i, n) {
          return void 0 === t && (t = this.prevIndex), void 0 === e && (e = this.index), void 0 === i && (i = this.dir || 1), void 0 === n && (n = this.transitionOptions), new this.Transitioner(B(t) ? this.slides[t] : t, B(e) ? this.slides[e] : e, i * (lt ? -1 : 1), n)
        }
      }
    };
    ...
    var Vr = {
          ...
          Transitioner: function(o, s, a, t) {
            ...
            return {
              ...
              translate: function(t) {
                this.reset();
                var e = n(t, a);
                Re(s, e[1]), Re(o, e[0]), Fr(s, "itemtranslatein", {
                  percent: t,
                  dir: a
      ...
      Rr = {
        ...
        events: [{
          ...
          name: "beforeitemshow",
          handler: function(t) {
            this.isToggled() || (this.draggable = !1, t.preventDefault(), this.toggleElement(this.$el, !0, !1), this.animation = Lr.scale, Be(t.target, this.clsActive), this.stack.splice(1, 0, this.index))
          }
        }, {
          name: "itemshow",
          handler: function() {
          ...
          handler: function(t, r) {
            ...
            var a, h, i, u = r.poster,
              c = r.attrs;
            void 0 === c && (c = {}), this.setItem(r, "<span uk-spinner></span>"), n && (h = {
              frameborder: "0",
              allow: "autoplay",
              allowfullscreen: "",
              ...
              return o.setError(r)
            })) : "iframe" === e || n.match(/\.(html|php)($|\?)/i) ? this.setItem(r, qr("iframe", G({
              src: n,
              frameborder: "0",
              allowfullscreen: "",
    ...
    var Ur, Yr = {
      ...
      methods: {
        show: function(t) {
          ...
          return M(t) && (i = Xr(t).source, t = y(n, function(t) {
            var e = t.source;
            return i === e
    ...
    var Kr = ["x", "y", "bgx", "bgy", "rotate", "scale", "color", "backgroundColor", "borderColor", "opacity", "blur", "hue", "grayscale", "invert", "saturate", "sepia", "fopacity", "stroke"],
      Jr = {
        ...
        computed: {
          props: function(m, g) {
            ...
            return Kr.reduce(function(t, e) {
              ...
              if (r ? (a = g.style.color, s = s.map(function(t) {
                  ...
                  return wi(t, h, v.$el)
                }), Re(g, "background-position-" + e[2], ""), n = Re(g, "backgroundPosition").split(" ")["x" === e[2] ? 0 : 1], i = v.covers ? (u = Math.min.apply(Math, s), c = Math.max.apply(Math, s), l = s.indexOf(u) < s.indexOf(c), d = c - u, s = s.map(function(t) {
                  return t - (l ? u : c)
                }), (l ? -d : 0) + "px") : n) : s = s.map(j), "stroke" === e) {
          ...
          covers: function(t, e) {
            return n = (i = e).style.backgroundSize, r = "cover" === Re(Re(i, "backgroundSize", ""), "backgroundSize"), i.style.backgroundSize = n, r;
            var i, n, r
          }
        },
        disconnected: function() {
        ...
        update: {
          read: function(t) {
            ...
            t.active = this.matchMedia, t.active && (t.image || !this.covers || !this.bgProps.length || (e = Re(this.$el, "backgroundImage").replace(/^none|url\(["']?(.+?)["']?\)$/, "$1")) && ((i = new Image).src = e, (t.image = i).naturalWidth || (i.onload = function() {
              return l.$update()
          ...
          Transitioner: function(r, n, o, t) {
            ...
            return {
              ...
              translate: function(t) {
                ...
                Re(a, "transform", Or(tt(e - e * t - u, -no(a), si(a).width) * (lt ? -1 : 1), "px")), this.updateTranslates(), r && (t = tt(t, -1, 1), oo(this.getItemIn(), "itemtranslatein", {
                  percent: t,
                  dir: o
        ...
        computed: {
          ...
          sets: function(t) {
            ...
            return !O(e = e && this.slides.reduce(function(t, e, i) {
              var n, r = si(e).width;
              return a < u + r && (!o.center && i > o.maxIndex && (i = o.maxIndex), b(t, i) || (n = o.slides[i + 1], o.center && n && r < h - si(n).width / 2 ? h -= r : (h = s, t.push(i), a = u + s + (o.center ? r / 2 : 0)))), u += r, t
            }, [])) && e
          },
          transitionOptions: function() {
            return {
      ...
      mo = {
        ...
        update: {
          read: function() {
            ...
            return this.minHeight && (i = Math.max(this.minHeight, i)), this.maxHeight && (i = Math.min(this.maxHeight, i)), {
      ...
      go = {
        ...
        methods: {
          init: function(t) {
            ...
            !r || n || 0 < i || Vt(e) || qt(e, "." + this.clsNoDrag) || this.handle && !qt(e, this.handle) || (t.preventDefault(), this.touched = [this], this.placeholder = r, this.origin = G({
              target: e,
              index: me(r)
          ...
          start: function(t) {
            var e, i, n;
            this.drag = (e = this.$container, i = this.placeholder, ot(n = be(e, i.outerHTML.replace(/(^<)(?:li|tr)|(?:li|tr)(\/>$)/g, "$1div$2")), "style", ot(n, "style") + ";margin:0!important"), Re(n, G({
              boxSizing: "border-box",
              width: i.offsetWidth,
              height: i.offsetHeight,
              overflow: "hidden"
            }, Re(i, ["paddingLeft", "paddingRight", "paddingTop", "paddingBottom"]))), ci(n.firstElementChild, ci(i.firstElementChild)), n);
            ...
            }), De(this.drag, this.clsDrag, this.clsCustom), De(this.placeholder, this.clsPlaceholder), De(this.items, this.clsItem), De(document.documentElement, this.clsDragState), Jt(this.$el, "start", [this, this.placeholder]), r = this.pos, o = Date.now(), lo = setInterval(function() {
              var t = r.x,
                a = r.y;
        ...
        methods: {
          show: function() {
            ...
            !this.isActive() && this.title && (vo.forEach(function(t) {
              return t.hide()
            }), vo.push(this), this._unbind = Xt(document, vt, function(t) {
          ...
          hide: function() {
            ...
            this.isActive() && !zt(this.$el, "input:focus") && this.toggleElement(this.tooltip, !1, !1).then(function() {
              vo.splice(vo.indexOf(t), 1), clearTimeout(t.showTimer), t.tooltip = $e(t.tooltip), t._unbind()
            })
          },
          _show: function() {
            var e = this;
                ...
                o = function(t) {
                  ...
                  de(n.url, {
                    ...
                    beforeSend: function(t) {
                      var e = t.xhr;
                      e.upload && Xt(e.upload, "progress", n.progress), ["loadStart", "load", "loadEnd", "abort"].forEach(function(t) {
